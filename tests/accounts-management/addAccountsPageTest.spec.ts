...
test("addAccounts",async({page})=>{
    ...
    const OKXSecret:string = "097F317095DDAC7F89CBBDB0";
    // Binance USD-M
    let USDMName:string = "AutomationTestUSDM";
    const USDMKey:string = "fnSrifSofyjR24ybGLIkXmETuy9ftDqGPObdUOoxmoKY9dd4TCJrnnNgPxcHt23";
    const USDMSecret:string = "4F0df7y4wKfqTTET2B2MOmMzWoFTXwz1d8rbDvEAVGhboKkJ";
    // Binance Coin-M
    let CoinMName:string = "AutomationTestCoinM";
    const CoinMKey:string = "fnSrifSofyjR24ybGLIkXm5ETuy9fDqGPObdUOoxmoKY9dd4TCJrnnNgPxcHt23";
    const CoinMSecret:string = "4h7y4wKfqTTET2B2MOmMzWoFTXwz1d8rbDvEAVGhboKkJ";
